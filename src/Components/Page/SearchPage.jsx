...
export default function SearchPage(props) {
    ...
    return (
        <main id='qc_tb_container'>
            ...
            <header id="qc_tb_searchPage_head">

                <span id="qc_tb_sphLeft"></span>

                <div id="qc_tb_sphMiddle">
                    <span id="qc_tb_sphSearchCont">
                ...
                <span id="qc_tb_sphRight">

                    <button ref={filterBtn} className={`qc_tb_btns ${filterBoxOpen ? 'active' : ''}`} onClick={() => filterBoxOpen ? setFilterBoxOpen(false) : setFilterBoxOpen(true)}>
