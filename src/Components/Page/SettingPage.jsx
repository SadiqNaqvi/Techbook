...
export default function SettingPage(props) {
    ...
    useEffect(() => {
        if (settingPage) {
            if (settingPage === 'personalize') {
                setSettingHeading('Personalization')
            } else if (settingPage === 'background') {
                setSettingHeading('background')
            } else if (settingPage === 'theme') {
                setSettingHeading('theme')
            } else if (settingPage === 'shortcut') {
                setSettingHeading('keyboard shortcut')
            } else if (settingPage === 'account') {
                setSettingHeading('account')
            } else if (settingPage === 'feedback') {
                setSettingHeading('feedback')
            } else if (settingPage === 'report') {
                setSettingHeading('report')
            } else if (settingPage === 'about') {
                setSettingHeading('about us')
            } else {
                navigate('/setting')
            }
        }
                    ...
                    !settingPage ?
                        ...
                        <>
                            <div id="qc_tb_stnpRHead">
                                ...
                                <div id="qc_tb_stnpRHLeft"></div>
                            </div>
                            <div id="qc_tb_stnpRBody">
                                {
