...
export default function CanvasPropEdit(prop) {
    ...
    useEffect(() => {
        ...
        if (document.getElementById('qc_tb_propEditPreview').childElementCount === 0) {
            document.getElementById('qc_tb_propEditPreview').appendChild(clonedProp);
        }
        setPropSize(sizeVal);
    ...
    useEffect(() => {
        ...
        if (!selProp.classList.contains('imageProp')) {
            color = document.querySelector('.selectedProp .selectedPropInner').style.getPropertyValue('--propColor');
            if (colorPickerRef.current && colorPickerRef.current?.childElementCount === 1) {
                const colorPicker = new iro.ColorPicker(`#${colorPickerRef.current.id}`, {
                    width: colorPickerRef.current.clientWidth - 20,
                    color: color,
                    layout: [
                        {
    ...
    const changePropSize = (val) => {
        ...
        setPropSize(val);
        if (propState === 'icon') {
            document.querySelector('#qc_tb_propEditPreview .selectedPropInner').style.setProperty('height', val + 'px');
            document.querySelector('#qc_tb_propEditPreview .selectedPropInner').style.setProperty('width', val + 'px');
        } else if (propState === 'text') {
            document.querySelector('#qc_tb_propEditPreview .selectedPropInner p').style.fontSize = val + 'px';
        } else if (propState === 'image') {
            document.querySelector('#qc_tb_propEditPreview .selectedPropInner img').style.width = val + 'px';
        }
    }
    ...
    const changeShapeScale = (prop, val) => {
        ...
        if (prop === 'height') {
            setPropHeight(val);
            document.querySelector('#qc_tb_propEditPreview .selectedPropInner').style.height = val + 'px';

        }
        else {
            setPropWidth(val);
            document.querySelector('#qc_tb_propEditPreview .selectedPropInner').style.width = val + 'px';
        }
    }
    ...
    const changePropRotate = (val) => {
        ...
        setPropRotate(val);
        document.getElementById('qc_tb_propEditPreview').querySelector('.selectedPropInner').style.setProperty('--rotate', `${val}deg`);
    }
    ...
    const changePropStyle = (val) => {
        let tempCont = [...propStyleArray];
        const selected = document.getElementById('qc_tb_propEditPreview').querySelector('.selectedPropInner p');
        if (val === 'Bold') {
    ...
    const handlePropShadow = (input, val) => {
        ...
        if (input === 'x') {
            ...
            selected.style.setProperty('--shadowBlur', val === 0 ? 'none' : `${val}px`);
        } else if (input === 'color') {
    ...
    const handleImageFilter = (input, val) => {
        ...
        if (input === 'blur') {
            selected.style.setProperty('--imgBlur', val === 0 ? '0px' : `${val}px`);
            setImgBlur(val);
            ...
            selected.style.setProperty('--imgSepia', imgSepia !== true ? '1' : '0');
            setImgSepia(!imgSepia);
        } else if (input === 'invert') {
            selected.style.setProperty('--imgInvert', imgInvert !== true ? '1' : '0');
    ...
    const addFrameToImg = (frame) => {
        ...
        if (frame !== 'none')
            selected.classList.add(`${frame}Frame`);
    }

    const handlePropFontChange = (font) => {
        document.getElementById('qc_tb_propEditPreview').querySelector('.selectedPropInner p').style.fontFamily = font;
    }
    ...
    return (
        <div id="qc_tb_canvasPropEdit">
            ...
            <div id="qc_tb_canvasPropEditCont">
                ...
                <div id="qc_tb_propEditPreview"></div>

                <div id="qc_tb_propEditOptions">
                    <div id="qc_tb_propEditOptionsTop">
                        {propState === 'text' ?
                            <button className={editOption === 'font' ? 'active' : null} onClick={() => setEditOption('font')}>
                        ...
                        <button className={editOption === 'style' ? 'active' : null} onClick={() => setEditOption('style')}>
                        ...
                        <button className={editOption === 'size' ? 'active' : null} onClick={() => setEditOption('size')}>
                        ...
                        {propState === 'image' ?
                            <button className={editOption === 'frame' ? 'active' : null} onClick={() => setEditOption('frame')}>
                        ...
                        <button className={editOption === 'rotate' ? 'active' : null} onClick={() => setEditOption('rotate')}>
                        ...
                        {propState !== 'image' ?
                            <button className={editOption === 'color' ? 'active' : null} onClick={() => setEditOption('color')}>
                    ...
                    <div id="qc_tb_propEditOptionsBottom">
                        ...
                        <div id="qc_tb_propEditBottom_default" className={editOption === 'none' ? 'active' : null}>
                            <p>Choose an option to show more!</p>
                        </div>

                        <div id="qc_tb_propEditBottom_font" className={editOption === 'font' ? 'active' : null}>
                        ...
                        <div id="qc_tb_propEditBottom_styleAndShadow" className={editOption === 'style' ? 'active' : null}>
                            ...
                            <div id="qc_tb_propEditBottom_shadow">
                                <span>
                                    Shadow X
                                    <input type="number" value={textShadowX} placeholder='X-Position' onChange={e => handlePropShadow('x', e.target.value === '' ? 0 : e.target.value)} />
                                </span>
                                <span>
                                    Shadow Y
                                    <input type="number" value={textShadowY} placeholder='Y-Position' onChange={e => handlePropShadow('y', e.target.value === '' ? 0 : e.target.value)} />
                                </span>
                                <span>
                                    Blur
                                    <input type="number" value={textShadowBlur} placeholder='Blur' onChange={e => handlePropShadow('blur', e.target.value > 0 ? e.target.value : 0)} />
                                </span>
                                <span>
                                    Color
                        ...
                        <div id="qc_tb_propEditBottom_frames" className={editOption === 'frame' ? 'active' : null}>
                        ...
                        <div id="qc_tb_propEditBottom_size" className={editOption === 'size' ? 'active' : null}>
                            {propState !== 'shape' ?
                                <>
                                    ...
                                    <div id="qc_tb_propEditBottom_sizeRight">
                                        <button onClick={() => changePropSize(10)}>10</button>
                                        <button onClick={() => changePropSize(20)}>20</button>
                                        <button onClick={() => changePropSize(25)}>25</button>
                                        <button onClick={() => changePropSize(30)}>30</button>
                                        <button onClick={() => changePropSize(40)}>40</button>
                                        <button onClick={() => changePropSize(50)}>50</button>
                                        <button onClick={() => changePropSize(75)}>75</button>
                                        <button onClick={() => changePropSize(100)}>100</button>
                                        <button onClick={() => changePropSize(200)}>200</button>
                                        <button onClick={() => changePropSize(250)}>250</button>
                                        <button onClick={() => changePropSize(300)}>300</button>
                                        <button onClick={() => changePropSize(400)}>400</button>
                                        <button onClick={() => changePropSize(500)}>500</button>
                                    </div>
                                </>
                                :
                                <>
                        ...
                        <div id="qc_tb_propEditBottom_rotate" className={editOption === 'rotate' ? 'active' : null}>
                            ...
                            <div id="qc_tb_propEditBottom_rotateRight">
                                <button onClick={() => changePropRotate(0)}>0</button>
                                <button onClick={() => changePropRotate(15)}>15</button>
                                <button onClick={() => changePropRotate(30)}>30</button>
                                <button onClick={() => changePropRotate(45)}>45</button>
                                <button onClick={() => changePropRotate(60)}>60</button>
                                <button onClick={() => changePropRotate(90)}>90</button>
                                <button onClick={() => changePropRotate(120)}>120</button>
                                <button onClick={() => changePropRotate(150)}>150</button>
                                <button onClick={() => changePropRotate(180)}>180</button>
                                <button onClick={() => changePropRotate(210)}>210</button>
                                <button onClick={() => changePropRotate(240)}>240</button>
                                <button onClick={() => changePropRotate(270)}>270</button>
                                <button onClick={() => changePropRotate(300)}>300</button>
                                <button onClick={() => changePropRotate(330)}>330</button>
                                <button onClick={() => changePropRotate(360)}>360</button>
                            </div>
                        </div>

                        <div id="qc_tb_propEditBottom_color" className={editOption === 'color' ? 'active' : null}>
