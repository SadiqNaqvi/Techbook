                    ...
                    {component === 'update' ?
                        ...
                        <div id="qc_tb_addToFolderInner" className={props.folderData ? "full" : "empty"}>
                            ...
                            <ul id="qc_tb_addToFolderBody">
                                {props.folderData.map(el => (
                                    ...
                                    <li key={el.key} className={`qc_tb_updateFolderTile ${checkedFolders.includes(el.key) ? 'checked' : ''}`} onClick={() => toggleFileInFolder(el.key)}>
                        ...
                        <div id="qc_tb_newFolderInner">
                            ...
                            <div id="qc_tb_newFolderHead">
                                <span id="qc_tb_newFolderHLeft"></span>

                                <span id="qc_tb_newFolderHMiddle">
